  ...
  return (
    <>
      <div className="lg:mx-20 lg:pt-5">
        <div className="navbar bg-gray-100 rounded-2xl shadow-sm">
          <div className="navbar-start">
            ...
            <div className="flex items-center gap-0 p-0 m-0">
              <img src="https://i.ibb.co/w1sqyr8/Green-Minimalist-Home-Logo-removebg-preview.png" alt="" className="w-15 h-18 p-0 m-0" />
              <a className="text-3xl p-0 m-0 italic font-bold">Fast-Track</a>
            </div>
          </div>
